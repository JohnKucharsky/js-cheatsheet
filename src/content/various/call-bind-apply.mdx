...
// Use `call` to get the square of `num` in `numbers`.
const result = mathUtils.square.call(numbers, numbers.num);
...
const delay = setTimeout.bind(null, delayedLog, 1000, "This is delayed!");
delay(); // Logs after 1 second: "This is delayed!"

const delay2 = () => setTimeout(delayedLog, 1000, "This is delayed!");
delay2(); // Logs after 1 second: "This is delayed!"
```
